...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mvMeasurement_p(F.mvMeasurement_p), mvMeasurement_g(F.mvMeasurement_g), mKeyCloud(F.mCloud), mvpMapPoints(F.mvpMapPoints), 
...
bool KeyFrame::isBad()
{
    // cout<<"Get KeyFrame bad Status..."<<endl;
    unique_lock<mutex> lock(mMutexConnections);
    // cout<<"Get KeyFrame bad Status Successful."<<endl;
    return mbBad;
}
...
/********************* Modified Here *********************/
void KeyFrame::AddMapPointBird(MapPointBird* pMP, const size_t &idx)
{
    unique_lock<mutex> lock(mMutexFeatures);
